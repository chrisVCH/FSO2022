...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    const cvalue = content.params.value
    const avalue = author.params.value
    const ivalue = info.params.value
    const object = { content: cvalue, author: avalue, info: ivalue, votes: 0 }
    props.addNew(object)
    navigate('/')
    props.showNotification(object)
  }
